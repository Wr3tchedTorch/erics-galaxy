...
let headerHTML = '<li><a href="' + relativePath + '/index.html">Home</a></li>' +
  '<li><a href="' + relativePath + '/virtualDiary.html">Virtual Diary</a></li>' +
  '<li><a href="' + relativePath + '/about.html">About</a></li>' +
  '<li><a href="' + relativePath + '/computer.html"><img src="./images/pages/home/21.gif"/>Computer</a></li>';
...
let footerHTML = "<hr><p>This blog was created by <a class='active' href='" + authorLink + "'>" + authorName + "</a><br> inspired by the small web style (1990-????)";
...
if (document.getElementById("header")) {
  const headerElement = document.getElementById("header").querySelector("ul");
  headerElement.innerHTML = headerHTML + headerElement.innerHTML;
}
